                                ...
                                <div class="tab-pane fade active show" id="general" role="tabpanel">
                                    <div class="post-details">
                                        <div class="row">
                                            ...
                                            <form class="form-valide" action="{{ url('/users/account_settings_update', [$items->users_customers_id]) }}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-4 form-group">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Enter a Last Name" value="{{ $items->last_name }}" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xl-4 form-group">
                                                        ...
                                                        <div class="col-lg-12"><input style="border:1px solid" type="tel"  name="mobile_number" id="phone" class="form-control" placeholder="Enter Mobile" value="{{ $items->phone }}"  required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xl-12 form-group">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <img src="{{ url('public') }}/{{ $items->profile_pic }}" width="150px" height="150px">
                                                        </div>
                                                    ...
                                                    <div class="col-xl-12 form-group row">
                                                        <div class="col-lg-12 ml-auto">
                                                            <input type="hidden" class="form-control" id="users_customers_id" name="users_customers_id" value="{{ $items->users_customers_id }}">
