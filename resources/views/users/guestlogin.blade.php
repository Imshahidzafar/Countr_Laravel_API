                            ...
                            <div class="row no-gutters">
                                <div class="col-xl-12">
                                    <div class="auth-form">
                                        ...
                                        <h4 class="text-center mb-4" style="color:#fff">Welcome To The User's Portal Guest Login</h4>
                                        <form  method="POST" action="{{url('/users/guestlogin_data')}}">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="first_name" name="last_name" placeholder="Enter Last Name " required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <button type="submit" class="btn btn-primary btn-block">Guest Login</button>
                                            </div>
                                        </form>
