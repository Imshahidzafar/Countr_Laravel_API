                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="/admin/survey_list_edit_data" method="POST" id="myform" name="myform" onsubmit="return validation()" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row col-md-12"> 
                                        ...
                                        <div class="form-group col-md-6">
                                            <b>Survey Name</b>
                                            <b><input style="border:1px solid" type="text" name="name" class="form-control" placeholder="Enter Name" value="{{$survey_list->name}}" required></b>
                                        </div>
                                        
                                        <div class="row col-md-6"> 
                                            <div id="profile-container">
                                                <img id="imagePreview" class="imagePreview" src="{{asset($survey_list->image)}}" />
                                            </div>
