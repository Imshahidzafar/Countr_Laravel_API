...
<html lang="en" class="h-100">
    <head>
        ...
        <link href="{{asset('css/style.css')}}" rel="stylesheet">
         <style>
            body{
               background-image: url("https://portal.countr.ai/public/uploads/system_image/adminbg.jpg");
                            ...
                            <div class="row no-gutters">
                                <div class="col-xl-12">
                                    <div class="auth-form">
                                        ...
                                        <h4 class="text-center mb-4" style="color:#fff;">Welcome to the Admin Portal</h4>
