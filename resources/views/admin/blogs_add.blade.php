                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="/admin/blogs_add_data" method="POST" id="myform" name="myform" onsubmit="return validation()" enctype="multipart/form-data">
                                    @csrf

                                    <div class="row col-md-12"> 
                                        <div class="form-group col-md-4">
                                            <b>Title</b>
                                            <b><input style="border:1px solid" type="text" name="title" class="form-control" placeholder="Enter Title" required></b>
                                        </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            <b>Description</b>
                                            <b><textarea style="border:1px solid" type="text" name="description" class="form-control" placeholder="Enter Description" required rows="10"></textarea></b>
                                        </div>
