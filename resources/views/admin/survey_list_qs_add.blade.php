                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="text" role="tabpanel">
                                        ...
                                        <div class="basic-form">
                                            <form action="/admin/survey_list_qs_add_data/{{$survey_list->survey_list_id}}" method="POST" id="myform_text" name="myform_text" enctype="multipart/form-data">
                                                @csrf
...
<!--             
                                    ...
                                    <div class="tab-pane fade" id="Multilevel_Choice">
                                        <div class="basic-form">
                                            <form action="/admin/multilevel_qs_add_data/{{$survey_list->survey_list_id}}" method="POST" id="myform_multilevel_choice" name="myform_multilevel_choice" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="row col-md-12 d-flex">            
                                                    ...
                                                    <div class="col-md-2 mt-4">    
                                                        <h4><strong>Mandatory</strong></h4>
                                                        <h4><strong><input style="border:2px solid" id="mandatory" type="checkbox" name="mandatory"></strong>
                                                        </h4>
                                                    </div>
                                                    <div class="col-md-2 mt-4">    
                                                        <span class="pull-right mt-4">
    ...
    <script>
        $(document).ready(function(){
            ...
            $(document).on('click','.addQuestionBtn_multilevel_choice',function(e){
                    ...
                    "url": "/admin/multilevel_parent_qs_add",
                    "method": "POST",
                    "data": {
        ...
        function get_answers_list(qs_id, answers_rows_counter){
            $.ajax({
                url: "/admin/get_list_answers/"+qs_id,data:{'answers_rows_counter':answers_rows_counter}, success: function(result){
