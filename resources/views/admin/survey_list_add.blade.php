                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="/admin/survey_list_add_data" method="POST" id="myform" name="myform" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <b>
                                                <select style="border:1px solid" name="users_partners_id" class="form-control" required>
                                                    ...
                                                    <option value="{{$data->users_partners_id}}">{{$data->first_name}} ({{$data->email}})</option>
                                                    <?php } ?>
                                                </select>
                                            </b>
                                        </div>
