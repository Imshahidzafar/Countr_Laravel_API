                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="/admin/survey_list_qs_edit_data/{{$survey_list->survey_list_id}}" method="POST" id="myform" name="myform" enctype="multipart/form-data">
                                    @csrf
        ...
        function remove_answers_rows(counter, survey_list_qs_answers_id = ''){
            if(survey_list_qs_answers_id != ''){
                ...
                if (confirm(text) == true) {
                    $.post(
                        "/admin/survey_list_qs_delete_answer/" + survey_list_qs_answers_id, 
