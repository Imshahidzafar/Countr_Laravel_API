        ...
        <div class="container-fluid">
            <div class="row page-titles mb-n5">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        @section('titleBar')
                        <span class="ml-2">Add Partner Users</span>
                        @endsection               
                    </ol>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="/admin/users_partners_add_data" method="POST" id="myform" name="myform" onsubmit="return validation()" enctype="multipart/form-data">
                                    @csrf

                                    <div class="row col-md-12"> 
                                        <div class="form-group col-md-6">
                                            <b>Partner First Name</b>
                                            <b><input style="border:1px solid" type="text" name="first_name" class="form-control" placeholder="Enter Partner Name" required></b>
                                        </div>

                                        <div class="form-group col-md-6">
                                            <b>Partner Email</b>
                                            <b><input style="border:1px solid" type="email" name="email" class="form-control" placeholder="Enter Partner Email" required></b>
                                        </div>

                                        <div class="form-group col-md-6">
                                            <b>Partner Password</b>
                                            <b><input style="border:1px solid" type="password" name="password" class="form-control" placeholder="Enter Partner Password" required></b>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            <b>Partner City</b>
                                            <b><input style="border:1px solid" type="text" name="city" class="form-control" placeholder="Enter Partner City" required></b>
                                        </div>

                                        <div class="form-group col-md-6">
                                            <b>Partner Address</b>
                                            <b><textarea style="border:1px solid" name="address" class="form-control" placeholder="Enter Partner Address" required></textarea></b>
                                        </div>
                                    </div>
