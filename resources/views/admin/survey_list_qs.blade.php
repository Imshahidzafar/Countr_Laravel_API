                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="basic-form" style="width: 100%;">
                                    <legend> 
                                        {{$survey_list->name}}
                                        <a style="float: right;" class="btn btn-primary" href="{{url('/admin/survey_list_qs_add/' . $survey_list->survey_list_id)}}"> Add Questions </a>
                                    </legend>
                                    <hr class="col-md-12">
                                        ...
                                        <table id="example" class="table dt-responsive nowrap display min-w850">
                                            ...
                                            @php $count = 0; @endphp
                                                ...
                                                <tr class="odd gradeX">
                                                    <td>{{ $count }}</td>
                                                    <td>
                                                        <a class="btn btn-info" href="{{url('/admin/survey_list_qs_sort_order/' . $items->survey_list_id . '/' . $items->survey_list_qs_id.'/up')}}">
                                                            <i class="fa fa-arrow-up"></i> 
                                                        </a>

                                                        <a class="btn btn-secondary" href="{{url('/admin/survey_list_qs_sort_order/' . $items->survey_list_id . '/' . $items->survey_list_qs_id.'/down')}}">
                                                    ...
                                                    <td>
                                                        <a class="btn btn-info" href="{{url('/admin/survey_list_qs_edit/' . $items->survey_list_id . '/' . $items->survey_list_qs_id)}}">
                                                            <i class="fa fa-pencil"></i> 
                                                        </a>

                                                        <a class="btn btn-secondary" href="{{url('/admin/survey_list_qs_update/' . $items->survey_list_id . '/' . $items->survey_list_qs_id . '/Active')}}">
                                                            <i class="fa fa-check"></i> 
                                                        </a>

                                                        <a class="btn btn-warning" href="{{url('/admin/survey_list_qs_update/' . $items->survey_list_id . '/' . $items->survey_list_qs_id . '/Inactive')}}">
                                                            <i class="fa fa-times"></i> 
                                                        </a>

                                                        <a class="btn btn-danger" href="{{url('/admin/survey_list_qs_delete/' . $items->survey_list_id . '/' . $items->survey_list_qs_id)}}">
