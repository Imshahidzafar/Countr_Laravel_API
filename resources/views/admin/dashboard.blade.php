					...
					<div class="card">
						<div style="padding: 0.25rem !important;" class="card-body p-4">
							...
							<div style="padding-left: 20px;padding-bottom: 20px;">
								...
								<span class="fs-14">Total Surveys Categories</span>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card">
						<div style="padding: 0.25rem !important;" class="card-body p-4">
							...
							<div style="padding-left: 20px;padding-bottom: 20px;">
								...
								<span class="fs-14">Total Surveys</span>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card">
						<div style="padding: 0.25rem !important;" class="card-body p-4">
							...
							<div style="padding-left: 20px;padding-bottom: 20px;">
								...
								<span class="fs-14">Total Survey Questions</span>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-xl col-md-6 col-sm-6">
					<div class="card">
						<div style="padding: 0.25rem !important;" class="card-body p-4">
							...
							<span class="donut1" data-peity="{ &quot;fill&quot;: [&quot;rgb(255, 195, 210)&quot;, &quot;rgba(255, 255, 255, 1)&quot;],   &quot;innerRadius&quot;: 45, &quot;radius&quot;: 10}" style="display: none;">3/8</span>
							<div style="padding-left: 20px;padding-bottom: 20px;">
								<h2 class="fs-24 text-black font-w600 mb-0">{{$total_users_partners}}</h2>
								<span class="fs-14">Total Partners</span>
							</div>
						</div>
					</div>
				</div>
		...
		(function($) {
			...
			var dzChartlist = function(){	
				...
				var fetchData = function() {
					$.ajax({
						url: '/admin/survey_responses_graph',
						method: 'GET',
						dataType: 'json',
