...
<input type="hidden" value="{{ $survey_list_id }}" id="survey_list_id">
                <!-- row -->
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card">
                                <div class="card-header d-sm-flex d-block pb-0 border-0">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="mr-auto pr-3">
                                            <h4 class="text-black fs-20">Survey Responses</h4>
                                            <p class="fs-13 mb-0 text-black">Take a look at your survey answers.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body pb-0">
                                    <div id="survey_responses_countries"></div>
                                </div>
                            </div>
                        </div>
                    <!--
    ...
    <script type="text/javascript">
		(function($) {
			...
			var dzChartlist = function(){	
				...
				var attempts;
				var country;
                var survey_list_id=$("#survey_list_id").val();

				var fetchData = function() {
					$.ajax({
						url: '/admin/survey_graph',
						method: 'GET',
						dataType: 'json',
                        data:{
						...
						success: function(response) {
							...
							country = response.data.names;
							// Call the chart rendering functions here
							chartBar();
							pieChart();
						},
				...
				var chartBar = function(){
					...
					var chartArea = new ApexCharts(document.querySelector("#survey_responses_countries"), optionsArea);
			        chartArea.render();
				}
                ...
                var optionsArea = {
                    series: [
                        <?php foreach($survey_list_qs as $questions){ 
                         $survey_list_qs_answers_1 = DB::table('survey_list_qs_answers')->where('survey_list_qs_id', $questions->survey_list_qs_id)->count(); 
                         $survey_list_qs_answers_2 = DB::table('survey_list_qs_answers')->where('survey_list_qs_id', $questions->survey_list_qs_id)->count(); 
                         $survey_list_qs_answers_3 = DB::table('survey_list_qs_answers')->where('survey_list_qs_id', $questions->survey_list_qs_id)->count(); 
                         $survey_list_qs_answers_4 = DB::table('survey_list_qs_answers')->where('survey_list_qs_id', $questions->survey_list_qs_id)->count(); 
                         $survey_list_qs_answers_5 = DB::table('survey_list_qs_answers')->where('survey_list_qs_id', $questions->survey_list_qs_id)->count(); 
                         $survey_list_qs_answers_6 = DB::table('survey_list_qs_answers')->where('survey_list_qs_id', $questions->survey_list_qs_id)->count(); 
                         $survey_list_qs_answers_7 = DB::table('survey_list_qs_answers')->where('survey_list_qs_id', $questions->survey_list_qs_id)->count(); 
                         $survey_list_qs_answers_8 = DB::table('survey_list_qs_answers')->where('survey_list_qs_id', $questions->survey_list_qs_id)->count(); 
                         $survey_list_qs_answers_9 = DB::table('survey_list_qs_answers')->where('survey_list_qs_id', $questions->survey_list_qs_id)->count(); 
                         $survey_list_qs_answers_10 = DB::table('survey_list_qs_answers')->where('survey_list_qs_id', $questions->survey_list_qs_id)->count(); 
                         $survey_list_qs_answers_11 = DB::table('survey_list_qs_answers')->where('survey_list_qs_id', $questions->survey_list_qs_id)->count(); 
                         $survey_list_qs_answers_12 = DB::table('survey_list_qs_answers')->where('survey_list_qs_id', $questions->survey_list_qs_id)->count(); ?>
                        {
