                            ...
                            <div class="basic-form">
                                <form action="/admin/users_system_edit_data" method="POST" id="myform" name="myform" onsubmit="return validation()" enctype="multipart/form-data">
                                    ...
                                    <div class="row col-md-12"> 
                                        ...
                                        <div class="form-group col-md-6">
                                            <b>Survey Allowed</b>
                                            <b><input style="border:1px solid" type="number" name="total_surveys_allowed" class="form-control" placeholder="Enter Total Survey Allowed" value="{{$users_system->total_surveys_allowed}}" required></b>
                                        </div>
                                    </div>
