                                ...
                                <div class="tab-pane fade active show" id="general" role="tabpanel">
                                    <div class="post-details">
                                        <div class="row">
                                            ...
                                            <form class="form-valide" action="{{ url('/partners/account_settings_update', [$items->users_partners_id]) }}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-4 form-group">
                                                        ...
                                                        <div class="col-lg-12">
                                                        <input style="border:1px solid" type="tel"  name="mobile_number" id="phone" class="form-control" placeholder="Enter Mobile" value="{{ $items->mobile }}" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xl-12 form-group row">
                                                        <div class="col-lg-12 ml-auto">
                                                            <input type="hidden" class="form-control" id="users_partners_id" name="users_partners_id" value="{{ $items->users_partners_id }}">
