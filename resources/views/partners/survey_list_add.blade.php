        ...
        <div class="container-fluid">
            <div class="row page-titles mb-n5">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        @section('titleBar')
                        <span class="ml-2">Add Survey</span>
                        @endsection               
                    </ol>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="/partners/survey_list_add_data" method="POST" id="myform" name="myform" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row col-md-12"> 
                                        <div class="form-group col-md-6 hidden">
                                            ...
                                            <b>
                                                <select style="border:1px solid" name="users_partners_id" class="form-control" required>
                                                    ...
                                                    <option value="{{$data->users_partners_id}}" <?php if($data->users_partners_id == session('id')) echo "selected"; ?>>{{$data->first_name}} ({{$data->email}})</option>
                                                    <?php } ?>
                                                </select>
                                            </b>
                                        </div>
                                            ...
                                            <b>
                                                <select style="border:1px solid" name="survey_categories_id" class="form-control" required>
                                                    <?php foreach($survey_categories as $data){ ?>
                                                        @if($data->name=="Partner Survey")
                                                            <option value="{{$data->survey_categories_id}}">{{$data->name}}</option>
                                                        @endif
                                                    <?php } ?>
                                                </select>
                                            </b>
                                        ...
                                        <div class="form-group col-md-6">
                                            <b>Survey Name</b>
                                            <b><input style="border:1px solid" type="text" name="name" class="form-control" placeholder="Enter Survey Name" required></b>
                                        </div>
