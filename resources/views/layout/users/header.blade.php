            ...
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul style="align-items: center;" class="navbar-nav header-right">
					...
					<span style="font-weight:bold; margin-left:5px; padding-left:20px; font-size: 20px;" class="name">
					    <?php
							$user_data = DB::table('users_customers')->select('first_name')->where('users_customers_id', session('users_id'))->get();
							echo $user_data[0]->first_name;
						?>    
					</span>
					
					<?php
						$img2=DB::table('users_customers')->select('profile_pic')->where('users_customers_id', session('users_id'))->get();
						$img=$img2[0]->profile_pic;
					?>
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                            ...
                            <a href="{{url('/users/logout')}}" class="dropdown-item ai-icon">
                                <svg id="icon-logout" xmlns="http://www.w3.org/2000/svg" class="text-danger" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
                                <span class="ml-1">Logout </span><br>
							</a>
